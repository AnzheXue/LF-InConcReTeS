#ifndef _networkreceiver_44_H
#define _networkreceiver_44_H
#ifndef _NETWORKRECEIVER_44_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_865155840_H
#define TOP_LEVEL_PREAMBLE_865155840_H
/*Correspondence: Range: [(25, 0), (117, 23)) -> Range: [(0, 0), (92, 23)) (verbatim=true; src=/mnt/c/Users/32739/lf/lf-inconcretes/fed-gen/inverted_pendulum/src/federate__s4.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
/*Correspondence: Range: [(120, 0), (133, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/lf/lf-inconcretes/fed-gen/inverted_pendulum/src/federate__s4.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
typedef struct networkreceiver_44_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} networkreceiver_44_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} networkreceiver_44_networkMessage_t;
#endif
#endif
