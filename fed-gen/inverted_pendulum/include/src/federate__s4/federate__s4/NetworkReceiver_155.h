#ifndef _networkreceiver_155_H
#define _networkreceiver_155_H
#ifndef _NETWORKRECEIVER_155_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1706315611_H
#define TOP_LEVEL_PREAMBLE_1706315611_H
/*Correspondence: Range: [(121, 0), (134, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
/*Correspondence: Range: [(25, 0), (118, 22)) -> Range: [(0, 0), (93, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#endif
typedef struct networkreceiver_155_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} networkreceiver_155_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} networkreceiver_155_networkMessage_t;
#endif
#endif
