#ifndef _networkreceiver_153_H
#define _networkreceiver_153_H
#ifndef _NETWORKRECEIVER_153_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct networkreceiver_153_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} networkreceiver_153_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} networkreceiver_153_networkMessage_t;
#endif
#endif
