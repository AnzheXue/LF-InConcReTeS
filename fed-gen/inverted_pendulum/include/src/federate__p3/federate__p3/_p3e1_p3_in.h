#ifndef __p3e1_p3_in_H
#define __p3e1_p3_in_H
#ifndef __P3E1_P3_IN_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct _p3e1_p3_in_self_t{
