#ifndef _networkreceiver_43_H
#define _networkreceiver_43_H
#ifndef _NETWORKRECEIVER_43_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct networkreceiver_43_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} networkreceiver_43_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} networkreceiver_43_networkMessage_t;
#endif
#endif
