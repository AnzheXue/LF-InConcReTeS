#ifndef __p3e2_p1_in_H
#define __p3e2_p1_in_H
#ifndef __P3E2_P1_IN_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct _p3e2_p1_in_self_t{
