#ifndef __p3e3_p3_in_H
#define __p3e3_p3_in_H
#ifndef __P3E3_P3_IN_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct _p3e3_p3_in_self_t{
