...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&federate__s1_nr_federate__s1_self[0]->_lf_networkMessage; \
    federate__s1_nr_federate__s1_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[0] = (lf_action_base_t*)&federate__s1_nr_federate__s1_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&federate__s1_nr_federate__s1_0_self[0]->_lf_networkMessage; \
    federate__s1_nr_federate__s1_0_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[1] = (lf_action_base_t*)&federate__s1_nr_federate__s1_0_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[2] = NEVER; \
    _lf_action_table[2] = (lf_action_base_t*)&federate__s1_nr_federate__s1_1_self[0]->_lf_networkMessage; \
    federate__s1_nr_federate__s1_1_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[2] = (lf_action_base_t*)&federate__s1_nr_federate__s1_1_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[3] = NEVER; \
    _lf_action_table[3] = (lf_action_base_t*)&federate__s1_nr_federate__s1_2_self[0]->_lf_networkMessage; \
    federate__s1_nr_federate__s1_2_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[3] = (lf_action_base_t*)&federate__s1_nr_federate__s1_2_self[0]->_lf_networkMessage; \
    staa_initialization(); \
} \
while (0)
/**
