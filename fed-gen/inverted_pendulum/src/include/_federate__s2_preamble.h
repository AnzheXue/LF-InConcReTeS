...
lf_action_base_t* _lf_zero_delay_cycle_action_table[4];
size_t _lf_zero_delay_cycle_action_table_size = 4;
reaction_t* network_input_reactions[4];
size_t num_network_input_reactions = 4;
reaction_t* port_absent_reaction[6];  // initialize to null pointers; see C99 6.7.8.10
size_t num_port_absent_reactions = 6;
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&federate__s2_nr_federate__s2_self[0]->_lf_networkMessage; \
    federate__s2_nr_federate__s2_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[0] = (lf_action_base_t*)&federate__s2_nr_federate__s2_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&federate__s2_nr_federate__s2_0_self[0]->_lf_networkMessage; \
    federate__s2_nr_federate__s2_0_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[1] = (lf_action_base_t*)&federate__s2_nr_federate__s2_0_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[2] = NEVER; \
    _lf_action_table[2] = (lf_action_base_t*)&federate__s2_nr_federate__s2_1_self[0]->_lf_networkMessage; \
    federate__s2_nr_federate__s2_1_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[2] = (lf_action_base_t*)&federate__s2_nr_federate__s2_1_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[3] = NEVER; \
    _lf_action_table[3] = (lf_action_base_t*)&federate__s2_nr_federate__s2_2_self[0]->_lf_networkMessage; \
    federate__s2_nr_federate__s2_2_self[0]->_lf_networkMessage.source_id = 8; \
    _lf_zero_delay_cycle_action_table[3] = (lf_action_base_t*)&federate__s2_nr_federate__s2_2_self[0]->_lf_networkMessage; \
    staa_initialization(); \
} \
while (0)
/**
...
void lf_send_neighbor_structure_to_RTI(int rti_socket) {
    ...
    message_head+=sizeof(int32_t);
    encode_uint16((uint16_t)8, &(buffer_to_send[message_head]));
