...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} _actuator_output_force_t;
typedef struct {
    struct self_base_t base;
#line 146 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p1/_actuator.h"
#line 147 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p1/_actuator.h"
    _actuator_input_force_t* _lf_input_force;
    // width of -2 indicates that it is not a multiport.
    int _lf_input_force_width;
    // Default input (in case it does not get connected)
    _actuator_input_force_t _lf_default__input_force;
    _actuator_output_force_t _lf_output_force;
    int _lf_output_force_width;
    reaction_t _lf__reaction_0;
    trigger_t _lf__input_force;
    reaction_t* _lf__input_force_reactions[1];
    #ifdef FEDERATED
