...
#ifndef _FAULTY_UNPUBLISHED_STORE_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1392425697_H
#define TOP_LEVEL_PREAMBLE_1392425697_H
/*Correspondence: Range: [(114, 0), (127, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p1.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
/*Correspondence: Range: [(25, 0), (111, 22)) -> Range: [(0, 0), (86, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p1.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#define PUBLISHING_INTERVAL 1000000
...
#endif
typedef struct faulty_unpublished_store_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    double error;
    double integral;
    double global_target;
    int end[0]; // placeholder; MSVC does not compile empty structs
} faulty_unpublished_store_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    #endif
} faulty_unpublished_store_error_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} faulty_unpublished_store_integral_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} faulty_unpublished_store_global_target_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} faulty_unpublished_store_output_error_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} faulty_unpublished_store_output_integral_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} faulty_unpublished_store_output_target_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
