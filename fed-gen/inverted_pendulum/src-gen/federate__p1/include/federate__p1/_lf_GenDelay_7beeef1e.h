#ifndef __lf_gendelay_7beeef1e_H
#define __lf_gendelay_7beeef1e_H
#ifndef __LF_GENDELAY_7BEEEF1E_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1793437465_H
#define TOP_LEVEL_PREAMBLE_1793437465_H
/*Correspondence: Range: [(25, 0), (104, 22)) -> Range: [(0, 0), (79, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p1.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
/*Correspondence: Range: [(107, 0), (120, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p1.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
typedef struct _lf_gendelay_7beeef1e_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    interval_t delay;
    int end[0]; // placeholder; MSVC does not compile empty structs
} _lf_gendelay_7beeef1e_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
