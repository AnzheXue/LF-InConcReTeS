...
#line 147 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p1/__p1sim_start_time.h"
    ...
    __p1sim_start_time_port0_t _lf_default__port0;
    // Array of output ports.
    __p1sim_start_time_port_t* _lf_port;
    int _lf_port_width;
    ...
    // array of pointers.
    __p1sim_start_time_port_t** _lf_port_pointers;
    trigger_t _lf__port0;
    #ifdef FEDERATED
    
    #endif // FEDERATED
} __p1sim_start_time_self_t;
__p1sim_start_time_self_t* new___p1sim_start_time();
#endif // __P1SIM_START_TIME_H
