#ifndef _federate__s3_main_H
#define _federate__s3_main_H
#ifndef _FEDERATE__S3_MAIN_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1562369613_H
#define TOP_LEVEL_PREAMBLE_1562369613_H
/*Correspondence: Range: [(25, 0), (118, 22)) -> Range: [(0, 0), (93, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s3.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
/*Correspondence: Range: [(121, 0), (134, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s3.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
typedef struct federate__s3_self_t{
