...
#include "include/federate__plant/_plantrequest_s2.h"
#include "__plantrequest_s2.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__plantrequest_s2_self_t* new___plantrequest_s2() {
    __plantrequest_s2_self_t* self = (__plantrequest_s2_self_t*)lf_new_reactor(sizeof(__plantrequest_s2_self_t));
