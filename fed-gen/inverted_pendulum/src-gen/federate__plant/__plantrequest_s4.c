...
#include "include/federate__plant/_plantrequest_s4.h"
#include "__plantrequest_s4.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__plantrequest_s4_self_t* new___plantrequest_s4() {
    __plantrequest_s4_self_t* self = (__plantrequest_s4_self_t*)lf_new_reactor(sizeof(__plantrequest_s4_self_t));
