#ifndef __lf_gendelay_92f49298_H
#define __lf_gendelay_92f49298_H
#ifndef __LF_GENDELAY_92F49298_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1578737182_H
#define TOP_LEVEL_PREAMBLE_1578737182_H
/*Correspondence: Range: [(109, 0), (122, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__plant.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
/*Correspondence: Range: [(20, 0), (106, 23)) -> Range: [(0, 0), (86, 23)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__plant.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#endif
typedef struct _lf_gendelay_92f49298_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    interval_t delay;
    int end[0]; // placeholder; MSVC does not compile empty structs
} _lf_gendelay_92f49298_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
