...
#ifndef _PLANT_ACTUATOR_H // necessary for arduino-cli, which automatically includes headers that are not used
...
#endif
typedef struct plant_actuator_self_t{
