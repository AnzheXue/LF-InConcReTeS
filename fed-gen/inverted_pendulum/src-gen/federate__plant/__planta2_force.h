...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} __planta2_force_port_t;
typedef struct {
    struct self_base_t base;
#line 146 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__plant/__planta2_force.h"
#line 147 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__plant/__planta2_force.h"
    __planta2_force_port0_t* _lf_port0;
    // width of -2 indicates that it is not a multiport.
    int _lf_port0_width;
    // Default input (in case it does not get connected)
    __planta2_force_port0_t _lf_default__port0;
    // Array of output ports.
    __planta2_force_port_t* _lf_port;
    int _lf_port_width;
    ...
    // array of pointers.
    __planta2_force_port_t** _lf_port_pointers;
    trigger_t _lf__port0;
    #ifdef FEDERATED
    
    #endif // FEDERATED
} __planta2_force_self_t;
__planta2_force_self_t* new___planta2_force();
#endif // __PLANTA2_FORCE_H
