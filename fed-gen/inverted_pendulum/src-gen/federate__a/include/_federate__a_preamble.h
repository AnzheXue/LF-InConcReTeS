...
void _lf_executable_preamble(environment_t* env) {
    ...
    lf_connect_to_rti("10.34.167.170", 0);
}
...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&federate__a_nr_federate__a_self[0]->_lf_networkMessage; \
    federate__a_nr_federate__a_self[0]->_lf_networkMessage.source_id = 4; \
    _lf_zero_delay_cycle_action_table[0] = (lf_action_base_t*)&federate__a_nr_federate__a_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&federate__a_nr_federate__a_0_self[0]->_lf_networkMessage; \
    federate__a_nr_federate__a_0_self[0]->_lf_networkMessage.source_id = 5; \
    _lf_zero_delay_cycle_action_table[1] = (lf_action_base_t*)&federate__a_nr_federate__a_0_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[2] = NEVER; \
    _lf_action_table[2] = (lf_action_base_t*)&federate__a_nr_federate__a_1_self[0]->_lf_networkMessage; \
    federate__a_nr_federate__a_1_self[0]->_lf_networkMessage.source_id = 6; \
    _lf_zero_delay_cycle_action_table[2] = (lf_action_base_t*)&federate__a_nr_federate__a_1_self[0]->_lf_networkMessage; \
    _lf_action_delay_table[3] = NEVER; \
    _lf_action_table[3] = (lf_action_base_t*)&federate__a_nr_federate__a_2_self[0]->_lf_networkMessage; \
    federate__a_nr_federate__a_2_self[0]->_lf_networkMessage.source_id = 7; \
    _lf_zero_delay_cycle_action_table[3] = (lf_action_base_t*)&federate__a_nr_federate__a_2_self[0]->_lf_networkMessage; \
    staa_initialization(); \
} \
while (0)
/**
