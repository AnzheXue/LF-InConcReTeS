...
#include "include/federate__s4/NetworkReceiver_153.h"
#include "_networkreceiver_153.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _networkreceiver_153reaction_function_0(void* instance_args) {
    _networkreceiver_153_self_t* self = (_networkreceiver_153_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    lf_critical_section_enter(self->base.environment);
    // Expose the action struct as a local variable whose name matches the action name.
    _networkreceiver_153_networkMessage_t* networkMessage = &self->_lf_networkMessage;
    ...
    _networkreceiver_153_msg_t* msg = &self->_lf_msg;
    #line 437 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf"
    msg->physical_time_of_arrival = self->_lf__networkMessage.physical_time_of_arrival;
    lf_set(msg, networkMessage->value);
#line 26 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__s4/_networkreceiver_153.c"
}
#include "include/api/reaction_macros_undef.h"
_networkreceiver_153_self_t* new__networkreceiver_153() {
    _networkreceiver_153_self_t* self = (_networkreceiver_153_self_t*)lf_new_reactor(sizeof(_networkreceiver_153_self_t));
    ...
    self->_lf__reaction_0.function = _networkreceiver_153reaction_function_0;
