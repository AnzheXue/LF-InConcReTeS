...
#include "include/federate__s4/NetworkSender_3_3.h"
...
void _networksender_3_3reaction_function_0(void* instance_args) {
    ...
    #line 325 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf"
...
#line 23 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__s4/_networksender_3_3.c"
}
...
void _networksender_3_3reaction_function_1(void* instance_args) {
    ...
    #line 334 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf"
    // Sending from msg[0] in federate federate__s4 to p4.CV_in in federate federate__p4
    if (!msg[0]->is_present) {
    return;
    }
    size_t _lf_message_length = sizeof(double);
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_TAGGED_MESSAGE, 3, 7, "federate 7 via the RTI", _lf_message_length, (unsigned char*)&msg[0]->value);
#line 38 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__s4/_networksender_3_3.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _networksender_3_3reaction_function_2(void* instance_args) {
    ...
    _networksender_3_3_msg_t** msg = self->_lf_msg;
    int msg_width = self->_lf_msg_width; SUPPRESS_UNUSED_WARNING(msg_width);
    #line 343 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__s4.lf"
    ...
    LF_PRINT_LOG("Executing port absent reaction for port %d to federate %d at time" PRINTF_TIME ".",
              3, 7, (long long) lf_time_logical_elapsed());
    if (msg[0] == NULL || !msg[0]->is_present) {
    LF_PRINT_LOG("The output port is NULL or it is not present.");
        lf_send_port_absent_to_federate(self->base.environment, NEVER, 3, 7);
    }
#line 55 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__s4/_networksender_3_3.c"
}
#include "include/api/reaction_macros_undef.h"
