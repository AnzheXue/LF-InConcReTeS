#ifndef __lf_gendelay_207d738b_H
#define __lf_gendelay_207d738b_H
#ifndef __LF_GENDELAY_207D738B_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_791519390_H
#define TOP_LEVEL_PREAMBLE_791519390_H
...
#endif
/*Correspondence: Range: [(25, 0), (111, 23)) -> Range: [(0, 0), (86, 23)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p2.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#endif
typedef struct _lf_gendelay_207d738b_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    interval_t delay;
    int end[0]; // placeholder; MSVC does not compile empty structs
} _lf_gendelay_207d738b_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
