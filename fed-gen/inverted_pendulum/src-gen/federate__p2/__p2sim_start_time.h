#ifndef __P2SIM_START_TIME_H
#define __P2SIM_START_TIME_H
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} __p2sim_start_time_port_t;
typedef struct {
    struct self_base_t base;
#line 146 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p2/__p2sim_start_time.h"
#line 147 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p2/__p2sim_start_time.h"
    __p2sim_start_time_port0_t* _lf_port0;
    // width of -2 indicates that it is not a multiport.
    int _lf_port0_width;
    // Default input (in case it does not get connected)
    __p2sim_start_time_port0_t _lf_default__port0;
    // Array of output ports.
    __p2sim_start_time_port_t* _lf_port;
    int _lf_port_width;
    ...
    // array of pointers.
    __p2sim_start_time_port_t** _lf_port_pointers;
    trigger_t _lf__port0;
    #ifdef FEDERATED
    
    #endif // FEDERATED
} __p2sim_start_time_self_t;
__p2sim_start_time_self_t* new___p2sim_start_time();
#endif // __P2SIM_START_TIME_H
