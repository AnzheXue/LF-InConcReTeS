...
#include "include/federate__p3/_p3sensor_data.h"
#include "__p3sensor_data.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__p3sensor_data_self_t* new___p3sensor_data() {
    __p3sensor_data_self_t* self = (__p3sensor_data_self_t*)lf_new_reactor(sizeof(__p3sensor_data_self_t));
