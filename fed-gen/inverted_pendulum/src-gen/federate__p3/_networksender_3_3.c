...
#include "include/federate__p3/NetworkSender_3_3.h"
...
void _networksender_3_3reaction_function_0(void* instance_args) {
    ...
    #line 1870 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p3.lf"
...
#line 23 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/_networksender_3_3.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _networksender_3_3reaction_function_1(void* instance_args) {
    _networksender_3_3_self_t* self = (_networksender_3_3_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _networksender_3_3_msg_t** msg = self->_lf_msg;
    int msg_width = self->_lf_msg_width; SUPPRESS_UNUSED_WARNING(msg_width);
    #line 1879 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p3.lf"
    // Sending from msg[0] in federate federate__p3 to p2.e1_p2p1_in in federate federate__p2
    if (!msg[0]->is_present) {
    return;
    }
    size_t _lf_message_length = sizeof(tuple);
    lf_send_tagged_message(self->base.environment, NEVER, MSG_TYPE_TAGGED_MESSAGE, 15, 5, "federate 5 via the RTI", _lf_message_length, (unsigned char*)&msg[0]->value);
#line 38 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/_networksender_3_3.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _networksender_3_3reaction_function_2(void* instance_args) {
    _networksender_3_3_self_t* self = (_networksender_3_3_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _networksender_3_3_msg_t** msg = self->_lf_msg;
    int msg_width = self->_lf_msg_width; SUPPRESS_UNUSED_WARNING(msg_width);
    #line 1888 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p3.lf"
    ...
    LF_PRINT_LOG("Executing port absent reaction for port %d to federate %d at time" PRINTF_TIME ".",
              15, 5, (long long) lf_time_logical_elapsed());
    if (msg[0] == NULL || !msg[0]->is_present) {
    LF_PRINT_LOG("The output port is NULL or it is not present.");
        lf_send_port_absent_to_federate(self->base.environment, NEVER, 15, 5);
    }
#line 55 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/_networksender_3_3.c"
}
#include "include/api/reaction_macros_undef.h"
_networksender_3_3_self_t* new__networksender_3_3() {
    ...
    self->_lf__reaction_1.function = _networksender_3_3reaction_function_1;
    ...
    self->_lf__reaction_2.function = _networksender_3_3reaction_function_2;
