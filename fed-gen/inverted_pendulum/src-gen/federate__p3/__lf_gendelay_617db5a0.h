...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} __lf_gendelay_617db5a0_act_t;
typedef struct {
    struct self_base_t base;
    interval_t delay;
#line 150 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/__lf_gendelay_617db5a0.h"
#line 151 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/__lf_gendelay_617db5a0.h"
    __lf_gendelay_617db5a0_act_t _lf_act;
    __lf_gendelay_617db5a0_inp_t* _lf_inp;
    // width of -2 indicates that it is not a multiport.
    int _lf_inp_width;
    // Default input (in case it does not get connected)
    __lf_gendelay_617db5a0_inp_t _lf_default__inp;
    __lf_gendelay_617db5a0_out_t _lf_out;
    int _lf_out_width;
    ...
    #endif // FEDERATED
} __lf_gendelay_617db5a0_self_t;
__lf_gendelay_617db5a0_self_t* new___lf_gendelay_617db5a0();
#endif // __LF_GENDELAY_617DB5A0_H
