...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} _unpublished_store_global_target_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} _unpublished_store_output_error_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} _unpublished_store_output_integral_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
    ...
    interval_t physical_time_of_arrival;
    #endif
} _unpublished_store_output_target_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
...
#line 216 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/_unpublished_store.h"
#line 217 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p3/_unpublished_store.h"
    _unpublished_store_error_t* _lf_error;
    // width of -2 indicates that it is not a multiport.
    int _lf_error_width;
    // Default input (in case it does not get connected)
    _unpublished_store_error_t _lf_default__error;
    _unpublished_store_integral_t* _lf_integral;
    // width of -2 indicates that it is not a multiport.
    int _lf_integral_width;
    // Default input (in case it does not get connected)
    _unpublished_store_integral_t _lf_default__integral;
    _unpublished_store_global_target_t* _lf_global_target;
    // width of -2 indicates that it is not a multiport.
    int _lf_global_target_width;
    // Default input (in case it does not get connected)
    _unpublished_store_global_target_t _lf_default__global_target;
    _unpublished_store_output_error_t _lf_output_error;
    int _lf_output_error_width;
    _unpublished_store_output_integral_t _lf_output_integral;
    int _lf_output_integral_width;
    _unpublished_store_output_target_t _lf_output_target;
    int _lf_output_target_width;
    _unpublished_store_sw_t _lf_sw;
    int _lf_sw_width;
    ...
    #endif // FEDERATED
} _unpublished_store_self_t;
_unpublished_store_self_t* new__unpublished_store();
#endif // _UNPUBLISHED_STORE_H
