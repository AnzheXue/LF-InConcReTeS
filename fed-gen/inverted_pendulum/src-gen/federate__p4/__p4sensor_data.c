...
#include "include/federate__p4/_p4sensor_data.h"
#include "__p4sensor_data.h"
// ***** Start of method declarations.
// ***** End of method declarations.
__p4sensor_data_self_t* new___p4sensor_data() {
    __p4sensor_data_self_t* self = (__p4sensor_data_self_t*)lf_new_reactor(sizeof(__p4sensor_data_self_t));
