#ifndef __lf_gendelay_1d74ce01_H
#define __lf_gendelay_1d74ce01_H
#ifndef __LF_GENDELAY_1D74CE01_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_657521724_H
#define TOP_LEVEL_PREAMBLE_657521724_H
...
#endif
/*Correspondence: Range: [(25, 0), (111, 22)) -> Range: [(0, 0), (86, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p4.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#endif
typedef struct _lf_gendelay_1d74ce01_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    interval_t delay;
    int end[0]; // placeholder; MSVC does not compile empty structs
} _lf_gendelay_1d74ce01_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
