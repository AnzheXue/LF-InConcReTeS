...
interval_t _lf_action_delay_table[5];
lf_action_base_t* _lf_action_table[5];
size_t _lf_action_table_size = 5;
lf_action_base_t* _lf_zero_delay_cycle_action_table[5];
size_t _lf_zero_delay_cycle_action_table_size = 5;
reaction_t* network_input_reactions[5];
size_t num_network_input_reactions = 5;
reaction_t* port_absent_reaction[2];  // initialize to null pointers; see C99 6.7.8.10
size_t num_port_absent_reactions = 2;
...
void staa_initialization() {
    ...
    staa_lst[0]->STAA = 0;
    staa_lst[0]->num_actions = 5;
    staa_lst[0]->actions = (lf_action_base_t**) malloc(sizeof(lf_action_base_t*) * 5);
