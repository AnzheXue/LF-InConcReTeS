...
#include "include/federate__p4/writer.h"
#include "_writer.h"
...
void _writerreaction_function_0(void* instance_args) {
    ...
    #line 375 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p4.lf"
    lf_set(output_target, global_target->value);
    add_total_writes(1);
    // lf_print("total_writes: %d\n", total_writes);
    lf_set(tw, total_writes);
    // lf_print("Write global target: %f\n", global_target->value);
#line 21 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p4/_writer.c"
}
...
void _writerreaction_function_1(void* instance_args) {
    ...
    _writer_tw_t* tw = &self->_lf_tw;
    #line 384 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p4.lf"
    lf_set(output_error, error->value);
    add_total_writes(1);
    // lf_print("total_writes: %d\n", total_writes);
    lf_set(tw, total_writes);
    // lf_print("Write error: %f\n", error->value);
#line 37 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p4/_writer.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _writerreaction_function_2(void* instance_args) {
    ...
    _writer_tw_t* tw = &self->_lf_tw;
    #line 393 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p4.lf"
    lf_set(output_integral, integral->value);
    add_total_writes(1);
    // lf_print("total_writes: %d\n", total_writes);
    lf_set(tw, total_writes);
    // lf_print("Write integral: %f\n", integral->value);
#line 53 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p4/_writer.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _writerreaction_function_3(void* instance_args) {
    ...
    #line 414 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src/federate__p4.lf"
    lf_set(output_force, force->value);
    // lf_print("Write force: %f\n", force->value);
#line 65 "/mnt/c/Users/32739/LF/LF-InConcReTeS/fed-gen/inverted_pendulum/src-gen/federate__p4/_writer.c"
}
#include "include/api/reaction_macros_undef.h"
