...
#include "include/inverted_pendulum/EIGtree2.h"
#include "_eigtree2.h"
...
void _eigtree2reaction_function_0(void* instance_args) {
    ...
    #line 769 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p1p2_out, p1p2_in->value);
    // lf_print("EIGtree2 received p1p2: %f\n", p1p2_in->value.value);
#line 17 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
...
void _eigtree2reaction_function_1(void* instance_args) {
    ...
    #line 774 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p1p3_out, p1p3_in->value);
    // lf_print("EIGtree2 received p1p3: %f\n", p1p3_in->value.value);
#line 29 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _eigtree2reaction_function_2(void* instance_args) {
    ...
    #line 779 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p2p1_out, p2p1_in->value);
    // lf_print("EIGtree2 received p2p1: %f\n", p2p1_in->value.value);
#line 41 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _eigtree2reaction_function_3(void* instance_args) {
    ...
    #line 784 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p2p3_out, p2p3_in->value);
    // lf_print("EIGtree2 received p2p3: %f\n", p2p3_in->value.value);
#line 53 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _eigtree2reaction_function_4(void* instance_args) {
    ...
    #line 789 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p3p1_out, p3p1_in->value);
    // lf_print("EIGtree2 received p3p1: %f\n", p3p1_in->value.value);
#line 65 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _eigtree2reaction_function_5(void* instance_args) {
    ...
    #line 794 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p3p2_out, p3p2_in->value);
    // lf_print("EIGtree2 received p3p2: %f\n", p3p2_in->value.value);
#line 77 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree2.c"
}
#include "include/api/reaction_macros_undef.h"
