...
#include "include/inverted_pendulum/Sensor.h"
#include "_sensor.h"
...
void _sensorreaction_function_0(void* instance_args) {
    ...
    #line 118 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(request, 0.0);
    lf_set(sim_start_time, lf_time_logical_elapsed());
    // lf_print("request = %f\n", request->value);
    // lf_print("out[1] = %f\n", out[1]->value);
    // lf_print("out[2] = %f\n", out[2]->value);
    // lf_print("out[3] = %f\n", out[3]->value);
#line 20 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_sensor.c"
}
...
void _sensorreaction_function_1(void* instance_args) {
    ...
    #line 127 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(AP_out, AP_in->value);
    // lf_print("AP_out = %f\n", AP_out->value);
#line 32 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_sensor.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _sensorreaction_function_2(void* instance_args) {
    ...
    #line 132 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(AV_out, AV_in->value);
    // lf_print("AV_out = %f\n", AV_out->value);
#line 44 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_sensor.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _sensorreaction_function_3(void* instance_args) {
    ...
    #line 137 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(CP_out, CP_in->value);
    // lf_print("CP_out = %f\n", CP_out->value);
#line 56 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_sensor.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _sensorreaction_function_4(void* instance_args) {
    ...
    #line 142 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(CV_out, CV_in->value);
    // lf_print("CV_out = %f\n", CV_out->value);
#line 68 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_sensor.c"
}
#include "include/api/reaction_macros_undef.h"
