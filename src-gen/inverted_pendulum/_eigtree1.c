...
#include "include/inverted_pendulum/EIGtree1.h"
#include "_eigtree1.h"
...
void _eigtree1reaction_function_0(void* instance_args) {
    ...
    #line 739 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p1_out, p1_in->value);
    // lf_print("EIGtree1 received p1: %f\n", p1_in->value.value);
#line 17 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree1.c"
}
...
void _eigtree1reaction_function_1(void* instance_args) {
    ...
    #line 744 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p2_out, p2_in->value);
    // lf_print("EIGtree1 received p2: %f\n", p2_in->value.value);
#line 29 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree1.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _eigtree1reaction_function_2(void* instance_args) {
    ...
    #line 748 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(p0p3_out, p3_in->value);
    // lf_print("EIGtree1 received p3: %f\n", p3_in->value.value);
#line 41 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree1.c"
}
#include "include/api/reaction_macros_undef.h"
