...
#include "include/inverted_pendulum/EIGtree0.h"
#include "_eigtree0.h"
...
void _eigtree0reaction_function_0(void* instance_args) {
    ...
    #line 724 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf"
    lf_set(round0_out, store_in->value);
    // lf_print("EIGtree0 received: %f\n", store_in->value.value);
#line 17 "/mnt/c/Users/32739/LF/LF-InConcReTeS/src-gen/inverted_pendulum/_eigtree0.c"
}
