...
#ifndef __LF_GENDELAY_DB840C54_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_698784309_H
#define TOP_LEVEL_PREAMBLE_698784309_H
/*Correspondence: Range: [(14, 4), (71, 22)) -> Range: [(0, 0), (57, 22)) (verbatim=true; src=/mnt/c/Users/32739/LF/LF-InConcReTeS/src/inverted_pendulum.lf)*/typedef struct {
    char key[32 + 1];
    double value;
    uint64_t time;
} tuple;
...
#endif
typedef struct _lf_gendelay_db840c54_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    interval_t delay;
    int end[0]; // placeholder; MSVC does not compile empty structs
} _lf_gendelay_db840c54_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
