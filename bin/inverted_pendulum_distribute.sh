...
scp -r RTI.tar.gz 10.34.167.169:LinguaFrancaRemote/inverted_pendulum/RTI.tar.gz
rm RTI.tar.gz
ssh 10.34.167.169 '\
...
scp -r federate__s1.tar.gz 10.34.167.170:LinguaFrancaRemote/inverted_pendulum/federate__s1.tar.gz
...
scp -r federate__s2.tar.gz 10.34.167.171:LinguaFrancaRemote/inverted_pendulum/federate__s2.tar.gz
...
ssh 10.34.167.171 'cd LinguaFrancaRemote/inverted_pendulum/bin; rm -rf build_federate__s2.sh; echo "#!/bin/bash -l" >> build_federate__s2.sh; chmod +x build_federate__s2.sh; echo "# Build commands for inverted_pendulum federate__s2" >> build_federate__s2.sh; echo "cd ~/LinguaFrancaRemote/inverted_pendulum/federate__s2" >> build_federate__s2.sh; echo "rm -rf build && mkdir -p build && cd build && cmake .. && make 2>&1 | tee -a ~/LinguaFrancaRemote/inverted_pendulum/log/build.log" >> build_federate__s2.sh; echo "mv federate__s2 ~/LinguaFrancaRemote/inverted_pendulum/bin" >>  build_federate__s2.sh; ~/LinguaFrancaRemote/inverted_pendulum/bin/build_federate__s2.sh'
...
scp -r federate__s3.tar.gz 10.34.167.172:LinguaFrancaRemote/inverted_pendulum/federate__s3.tar.gz
...
ssh 10.34.167.172 'cd LinguaFrancaRemote/inverted_pendulum/bin; rm -rf build_federate__s3.sh; echo "#!/bin/bash -l" >> build_federate__s3.sh; chmod +x build_federate__s3.sh; echo "# Build commands for inverted_pendulum federate__s3" >> build_federate__s3.sh; echo "cd ~/LinguaFrancaRemote/inverted_pendulum/federate__s3" >> build_federate__s3.sh; echo "rm -rf build && mkdir -p build && cd build && cmake .. && make 2>&1 | tee -a ~/LinguaFrancaRemote/inverted_pendulum/log/build.log" >> build_federate__s3.sh; echo "mv federate__s3 ~/LinguaFrancaRemote/inverted_pendulum/bin" >>  build_federate__s3.sh; ~/LinguaFrancaRemote/inverted_pendulum/bin/build_federate__s3.sh'
...
scp -r federate__s4.tar.gz 10.34.167.173:LinguaFrancaRemote/inverted_pendulum/federate__s4.tar.gz
...
ssh 10.34.167.173 'cd LinguaFrancaRemote/inverted_pendulum/bin; rm -rf build_federate__s4.sh; echo "#!/bin/bash -l" >> build_federate__s4.sh; chmod +x build_federate__s4.sh; echo "# Build commands for inverted_pendulum federate__s4" >> build_federate__s4.sh; echo "cd ~/LinguaFrancaRemote/inverted_pendulum/federate__s4" >> build_federate__s4.sh; echo "rm -rf build && mkdir -p build && cd build && cmake .. && make 2>&1 | tee -a ~/LinguaFrancaRemote/inverted_pendulum/log/build.log" >> build_federate__s4.sh; echo "mv federate__s4 ~/LinguaFrancaRemote/inverted_pendulum/bin" >>  build_federate__s4.sh; ~/LinguaFrancaRemote/inverted_pendulum/bin/build_federate__s4.sh'
echo "Making directory LinguaFrancaRemote and subdirectories federate_name, bin, and log on host 10.34.167.170"
ssh 10.34.167.170 '\
    mkdir -p ~/LinguaFrancaRemote/inverted_pendulum/bin ~/LinguaFrancaRemote/inverted_pendulum/log; \
...
echo "**** Copying tarfile to host 10.34.167.170"
scp -r federate__p1.tar.gz 10.34.167.170:LinguaFrancaRemote/inverted_pendulum/federate__p1.tar.gz
...
echo "**** Copying tarfile to host 10.34.167.171"
scp -r federate__p2.tar.gz 10.34.167.171:LinguaFrancaRemote/inverted_pendulum/federate__p2.tar.gz
...
echo "**** Copying tarfile to host 10.34.167.172"
scp -r federate__p3.tar.gz 10.34.167.172:LinguaFrancaRemote/inverted_pendulum/federate__p3.tar.gz
...
echo "**** Copying tarfile to host 10.34.167.173"
scp -r federate__p4.tar.gz 10.34.167.173:LinguaFrancaRemote/inverted_pendulum/federate__p4.tar.gz
...
echo "**** Copying tarfile to host 10.34.167.169"
scp -r federate__plant.tar.gz 10.34.167.169:LinguaFrancaRemote/inverted_pendulum/federate__plant.tar.gz
